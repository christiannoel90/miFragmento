package arellano.christian.mifragmento
...
class fragment1 : Fragment() {
    ...
    override fun onCreateView(
        ...
        val miVista = inflater.inflate(R.layout.fragment_fragment1, container, false)
//instanciar widgets
        etUrl = miVista.findViewById(R.id.etUrl)
        btnIr = miVista.findViewById(R.id.btnIr)
        progreso = miVista.findViewById(R.id.progreso)
        navegador = miVista.findViewById(R.id.navegador)
